function y=cdom_model_2gaussian_noK(x,a,s,sigma1,phi1,mu1,sigma2,phi2,mu2,lam0)

% cdom_model_2gaussian_noK
%
% y=cdom_model_2gaussian_noK(x,a,s,sigma1,phi1,mu1,sigma2,phi2,mu2,lam0)
%
% Models a single exponential and 2 Gaussian curves to estimate an
% absorption spectra
%
% Inputs:
...
y=a.*exp(-(x-lam0).*s)+phi1.*exp(-(x-mu1).^2./(2.*sigma1.^2))+phi2.*exp(-(x-mu2).^2./(2.*sigma2.^2));
function y=gauss2(x,sigma1,phi1,mu1,sigma2,phi2,mu2)

% gauss2
%
% y=gauss2(x,sigma1,phi1,mu1,sigma2,phi2,mu2)
%
...
%     sigma2 = width of 2nd Gaussian curve
%     phi2   = height of 2nd Gaussian curve
%     mu2    = spectral location of 2nd Gaussian curve (center)
%
% Returns:
...
y=phi1.*exp(-(x-mu1).^2./(2.*sigma1.^2))+phi2.*exp(-(x-mu2).^2./(2.*sigma2.^2));